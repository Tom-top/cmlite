...
def get_net(input_dim=(64, 64, 64)):  # Example input dimensions
    # Correctly define the Input layer using input_dim
    input_layer = Input(shape=(*input_dim, 1))

    # Level 1
    conv1 = Conv3D(32, (3, 3, 3), activation="relu", padding="same")(input_layer)
    ...
    # Update optimizer and compile model

...
data_heatmaps_directory = os.path.join(heatmaps_directory, "Zhuang-ABCA-1")
...
metadata = manifest['file_listing']['Zhuang-ABCA-1']['metadata']
metadata_ccf = manifest['file_listing']['Zhuang-ABCA-1-CCF']['metadata']
expression_matrices = manifest['file_listing']['Zhuang-ABCA-1']['expression_matrices']

cell_metadata_path = expression_matrices['Zhuang-ABCA-1']['log2']['files']['h5ad']['relative_path']

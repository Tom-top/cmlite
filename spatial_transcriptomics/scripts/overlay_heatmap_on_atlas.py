...
analysis_directory = r"E:\tto\spatial_transcriptomics_results\Semaglutide_2\Semaglutide"
mask_path = os.path.join(os.path.join(analysis_directory, "result.nii.gz"))
...
clip_min = 250  # Set the minimum value to retain
adjust_max = 250
...
colormap = cm.get_cmap('viridis')  # You can choose any colormap here
...
alpha_min = 250  # Lower bound of the range
alpha_max = 350  # Upper bound of the range

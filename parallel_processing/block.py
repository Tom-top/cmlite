...
class Block(slc.Slice):
    ...
    def __init__(self, source=None, slicing=None, valid=None, valid_slicing=None, offsets=None, index=None,
                 iteration=None, blocks_shape=None, neighbours=None, name=None):
        """Constructor"""
    ...
    def as_memory_block(self):
        ...
        return Block(source=source, slicing=slice(None), valid_slicing=self.valid.slicing, index=self.index,
